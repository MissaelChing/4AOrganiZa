...
namespace OrganiZaUI.Pages
{
    public class VCalendarioModel : PageModel
    {
        ...
        public TutorModels Tuto = new TutorModels();
        ...
        public IRepositoryCalendario repositoryusuarios;
        ...
        public VCalendarioModel(IRepositoryCalendario repositoryCalendario, IRepositoryRegistroEscuela repositoryRegistroEscuela, IRepository<CalendarioModels> repository, AppDBContext context, IRepositoryRegistroTutor repositorytutor, IRepositoryCalendario repositoryusuarios)
        {
        ...
        public IActionResult OnGet()
        {
            ...
            repositorytutor.BuscarEscuela(Tuto);
            Escuelas = repositoryRegistroEscuela.GetE(Tuto.IdE);
