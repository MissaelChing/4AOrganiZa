...
{
    public class ACalendarioModel : PageModel
    {
        [BindProperty]
        ...
        public ACalendarioModel(IRepositoryCalendario repositoryCalendario, IRepositoryRegistroEscuela repositoryRegistroEscuela, IRepository<CalendarioModels> repository, AppDBContext context, IRepositoryRegistroTutor repositorytutor)
        {
